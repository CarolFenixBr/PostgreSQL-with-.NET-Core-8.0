...
namespace PostgreSQL_with_.NET_Core_8._0.Controllers
{
    public class EstudantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sobrenome,Email,Telefone,Endereco")] estudante estudante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome,Email,Telefone,Endereco")] estudante estudante)
        {
            if (id != estudante.Id)
            {
                return NotFound();
